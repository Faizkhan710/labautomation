      ...
      <div class="row">
       ...
       <div class="col-xxl-4 col-md-6">
          <div class="card info-card sales-card">
            ...
            <div class="card-body">
              <h5 class="card-title">Uploaded <span>| Products</span></h5>
              ...
              <div class="d-flex align-items-center">
                ...
                <div class="ps-3">
                  <?php
                  $countassigned="SELECT count(p_id) as count from addproducts ";
        ...
        <div class="col-xxl-4 col-xl-12">
          ...
          <div class="card info-card customers-card">
            ...
            <div class="card-body">
              ...
              <div class="d-flex align-items-center">
                ...
                <div class="ps-3">
                <?php
                  $dispro= "SELECT count(p_id) as count from addproducts where p_status='0' ";
          ...
          <div class="card top-selling overflow-auto">
            <div class="card-body pb-0">
              <h5 class="card-title">Uploaded Products:</h5>
              ...
              <table class="table table-borderless">
                ...
                <?php
                  $selectquery="SELECT * from addproducts where p_status='1'";
                  $runquery=mysqli_query($connect,$selectquery);
                  while($row=mysqli_fetch_array($runquery)){ ?>
                      <tbody>
                  <tr>
                    <th scope="row"><img src="images/<?php echo $row['p_image']; ?>" alt=""></th>
          ...
          <div class="card top-selling overflow-auto">
            <div class="card-body pb-0">
              ...
              <table class="table table-borderless">
                ...
                <?php
                  $selectquery="SELECT * from addproducts where p_status='2'";
                  $runquery=mysqli_query($connect,$selectquery);
                  while($row=mysqli_fetch_array($runquery)){ ?>
                      <tbody>
                  <tr>
