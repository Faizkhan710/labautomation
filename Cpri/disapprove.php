...
<?php 
    if(isset($_POST['submit'])){
      ...
      $updatequery="UPDATE tested SET testing_id = '$testing', comments='$comment' where product_id='$id'";
      $updatestatusquery="UPDATE addproducts set p_status='0' where p_id='$id'";
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Disapprove Product</h5>
              ...
              <form method="post" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <button type="submit" class="btn btn-primary" name="submit">Disapprove Product</button>
                  </div>
                </div>
